...
public class CacheFactory {
    ...
    private static final Map<Class<?>, IReadOnlyCache> ROCACHES = new HashMap<>();

    private static List<CacheXml.ReadOnlyCacheItem> readonlyCacheItems;

    private static final Set<String> ROCACHE_CLAZZNAME = new HashSet<>();

    private static final Set<String> ROCACHE_NEEDINIT = new HashSet<>();
