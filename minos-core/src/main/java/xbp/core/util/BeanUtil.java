...
public class BeanUtil {
     ...
     * @throws InstantiationException
     */
    public static <T extends BaseModel> List<T> getModelList(String json, Class<T> clazz) {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> T getModel(Class<T> clazz, Map<String, Object> inMap) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<Map<String, Object>> getMapList(List<T> list) {
