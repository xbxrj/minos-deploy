package xbp.core.exception.base;

import xbp.core.exception.IException;
 ...
 */
public enum BaseCommonException implements IException {
    ...
    BaseCommonException(String message) {
        this.message = message;
        this.level = ExceptionLevel.ERROR;
    }

    BaseCommonException(String message, ExceptionLevel level) {
        this.message = message;
        this.level = level;
    }

    BaseCommonException(String message, long errorCode) {
        this.message = message;
        this.level = ExceptionLevel.ERROR;
        this.errorCode = errorCode;
    }

    BaseCommonException(String message, ExceptionLevel level, long errorCode) {
        this.message = message;
        this.level = level;
        this.errorCode = errorCode;
    }
