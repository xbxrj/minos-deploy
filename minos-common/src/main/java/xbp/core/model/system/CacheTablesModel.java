 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-11-14 21:43:39
 *       表：SYS_L_CACHE_TABLES 
 */
public class CacheTablesModel  extends BaseModel implements Serializable{
    
    private static final long serialVersionUID = 3741040459349919855L;
   ...
   static{
        propertes.add("tableName");
        propertes.add("status");
        propertes.add("deletedFlag");
        propertes.add("cacheCond");
        propertes.add("cacheColumns");
        propertes.add("primaryColumns");
        propertes.add("indexes");
        propertes.add("farmFlag");
        propertes.add("farmColumn");
        propertes.add("orderColumn");
