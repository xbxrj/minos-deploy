 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-11-14 21:46:39
 *       表：CD_O_BUTTON 
 */
public class ButtonModel  extends BaseModel implements Serializable{
    
    private static final long serialVersionUID = -3421610830938150414L;
   ...
   static{
        ...
        propertes.add("pageId");
        propertes.add("btnType");
        propertes.add("btnCode");
        propertes.add("btnName");
        propertes.add("iconCls");
        propertes.add("funName");
    }
