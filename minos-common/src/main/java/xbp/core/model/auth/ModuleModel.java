 ...
 * @Description:系统生成
 * @author :系统生成
 * @date :2016-11-14 21:46:29
 *       表：CD_O_MODULE 
 */
public class ModuleModel  extends BaseModel implements Serializable{
    
    private static final long serialVersionUID = -4989182657018710440L;
   ...
   static{
        ...
        propertes.add("notes");
        propertes.add("moduleCode");
        propertes.add("moduleName");
        propertes.add("sortName");
        propertes.add("moduleEnNa");
        propertes.add("sortEnNa");
        propertes.add("iconCls");
        propertes.add("glyph");
        propertes.add("clickEvent");
        propertes.add("menuType");
        propertes.add("component");
        propertes.add("moduleUrl");
        propertes.add("usingFlag");
        propertes.add("isQuickMenu");
    }
