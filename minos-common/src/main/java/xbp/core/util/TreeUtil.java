...
import xbp.core.model.base.TreeNode;
...
public class TreeUtil {
    ...
    public static List<Map<String, Object>> getDet(List<DeptModel> list, long parentId) {
        List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
        ...
        for (DeptModel model : list) {
            ...
            if (parentId == supCompanyId) {
                List<Map<String, Object>> children = getDet(list, companyId);
                map.put("children", children);
                result.add(map);
            }
        }
