...
import xbp.core.cache.BasicTableCache;
import xbp.core.cache.MaterialInfoReadOnlyCache;
import xbp.core.cache.PigInfoReadOnlyCache;
import xbp.core.cache.cachemanager.CacheManager;
import xbp.core.cache.cachemanager.CacheTable;
import xbp.core.data.enums.CodeEnum;
import xbp.core.data.enums.NameEnum;
import xbp.core.data.enums.interfaces.ICodeEnum;
import xbp.core.data.enums.interfaces.IInfoEnum;
import xbp.core.data.enums.interfaces.INameEnum;
import xbp.core.data.enums.interfaces.IPigInfoEnum;
import xbp.core.exception.Thrower;
import xbp.core.exception.base.CacheBusiException;
...
public class CacheUtil {
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setEarBrand(List<T> list) throws Exception {
    //
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setEarBrand(List<T> list, String id) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setMaterialName(List<T> list) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setMaterialName(List<T> list, String id) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setPigClassName(List<T> list) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setPigClassName(List<T> list, String id) throws Exception {
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setCodeName(List<T> list, CodeEnum typeCode) throws Exception {
    //
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setCodeName(List<T> list, String id, CodeEnum typeCode) throws Exception {
    //
    // if (list != null && list.size() > 0) {
    // for (T t : list) {
    // Map<String, Object> map = t.getData();
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setHouseTypeName(List<T> list) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setHouseTypeName(List<T> list, String id) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setLineName(List<T> list) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setLineName(List<T> list, String id) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setHouseName(List<T> list) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setHouseName(List<T> list, String id) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, INameEnum[] columns, ICodeEnum... codeEnums) throws Exception {
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setName(List<T> list, NameEnum[] columns) throws Exception {
    //
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, INameEnum[] columns, String[] ids, ICodeEnum... codeEnums)
            throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, INameEnum[] columns, String[] ids, String[] names, ICodeEnum... codeEnums)
            throws Exception {
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setName(List<T> list, NameEnum nameEnum) throws Exception {
    //
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setName(List<T> list, String id, NameEnum nameEnum) throws Exception {
    //
    // String[] ids = id.split(",");
    // return setName(list, nameEnum, ids);
    // }
     ...
     * @throws Exception
     */
    // public static <T extends BaseModel> List<T> setName(List<T> list, String[] ids, NameEnum nameEnum) throws Exception {
    //
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, NameEnum nameEnum, CodeEnum... codeEnums) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, NameEnum nameEnum, String id, CodeEnum... codeEnums) throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, NameEnum nameEnum, String id, String name, CodeEnum... codeEnums)
            throws Exception {
     ...
     * @throws Exception
     */
    public static <T extends BaseModel> List<T> setName(List<T> list, NameEnum nameEnum, String[] ids, String[] names, CodeEnum... codeEnums)
            throws Exception {
    ...
    public static long getFarmId() {
        ...
        LoginUserView user = (LoginUserView) SecurityUtils.getSubject().getSession().getAttribute("userDetail");
        return user.getCompanyModel().getRowId();
    }
    ...
    public static Map<String, String> getMaterialInfo(String materialId, IInfoEnum materialInfoEnum, String[] name, Long farmId) throws Exception {
        ...
        // 取缓存物料主数据
        Map<String, String> map = getMaterialInfoCahe().getMaterialInfo(farmId, materialId);
     ...
     * @throws Exception
     */
    public static void MaterialInfoCaheRefresh() throws Exception {

        getMaterialInfoCahe().refresh();
    }
     ...
     * @throws Exception
     */
    public static void MaterialInfoCaheRefresh(long farmId) throws Exception {

        getMaterialInfoCahe().refresh(farmId);
    }
     ...
     * @throws Exception
     */
    private static MaterialInfoReadOnlyCache getMaterialInfoCahe() throws Exception {
